...
@Database(entities = [MovieEntity::class, TvShowEntity::class, MovieRemoteKey::class, TvShowRemoteKey::class], version = 1)
abstract class AppDatabase : RoomDatabase() {
    abstract fun movieDao(): MovieDao
    abstract fun tvShowDao(): TvShowDao
    abstract fun movieRemoteKeyDao(): MovieRemoteKeysDao
    abstract fun tvShowRemoteKeyDao(): TvShowRemoteKeysDao
}